...
async function fetchDashboardData() {
    ...
    document.getElementById("kpi-residents").textContent = data.kpis.residents_total;
    document.getElementById("kpi-devices").textContent = data.device_status.online;
    document.getElementById("kpi-warnings").textContent = data.kpis.active_warnings;
    document.getElementById("kpi-revenue").textContent = Math.floor(data.kpis.revenue_total).toLocaleString();
    ...
    document.getElementById("dev-online-num").textContent = data.device_status.online;
    document.getElementById("dev-offline-num").textContent = data.device_status.offline;
    document.getElementById("dev-lowpower-num").textContent = data.device_status.low_power;
}
